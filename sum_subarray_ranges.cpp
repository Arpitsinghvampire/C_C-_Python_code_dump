...
//here we will repeat the previous question but we will  find the next max and the previous max 
...
long long sum_of_subarray_maximums(vector<int>& arr)
{
    int n = arr.size();

    vector<int> pse = previous_greater_element(arr);
    vector<int> nse = next_greater_element(arr);
...
int main()
{
    ...
    cout << "Sum of Subarray maximums  = "
         << sum_of_subarray_maximums(arr)
         << endl;
